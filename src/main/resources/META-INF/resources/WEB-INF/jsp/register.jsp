   ...
   <td class="login_msg" width="400" align="center">
	 ...
	 <fieldset style="width: auto; margin: 0px auto;">
		...
		<form action="${pageContext.request.contextPath }/success" 
          ...
          账&nbsp;号：<input id="user_code" type="text" name="user_code" placeholder="请输入账号"/><br /><br />
          姓&nbsp;名：<input type="text" placeholder="请输入姓名" id="user_name"  name="user_name"/></br><br />
          密&nbsp;码：<input id="uesr_password" type="password" name="uesr_password" placeholder="请输入密码"/><br /><br />
         
          <center><input type="submit" value="注册" style="height: 40px; width: 80px; margin-top: 20px; color:#000; 
				   background-color:#09C; font-size: 15px;" /></center>
		 </form>
		 </label>
		</div>
	 </fieldset>
